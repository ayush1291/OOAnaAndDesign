...
public class Runner2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(inv.searchGuitar(new GuitarSpec(Model.MODEL1, Wood.ALDER)).size());
		
		System.out.println("***********");
		System.out.println("Searching for Guitar with model 1 and wood wood2");
		System.out.println(inv.searchGuitar(new GuitarSpec(Model.MODEL1, Wood.WOOD2)).size());
		
		System.out.println("***********");
		System.out.println("Searching for Guitar with model 2 and wood alder");
		System.out.println(inv.searchGuitar(new GuitarSpec(Model.MODEL2, Wood.ALDER)).size());
		
		
		System.out.println("***********");
		System.out.println("Searching for Mandolin with model 1 and wood alder and type 1");
		System.out.println(inv.searchMandolin(new MandolinSpec(Model.MODEL1, Wood.ALDER, Type.TYPE1)).size());
		
		System.out.println("***********");
		System.out.println("Searching for Mandolin with model 1 and wood wood2 and type 1");
		System.out.println(inv.searchMandolin(new MandolinSpec(Model.MODEL1, Wood.WOOD2, Type.TYPE1)).size());
		
		System.out.println("***********");
		System.out.println("Searching for Mandolin with model 1 and wood wood1 and type 2");
		System.out.println(inv.searchMandolin(new MandolinSpec(Model.MODEL1, Wood.ALDER, Type.TYPE2)).size());
